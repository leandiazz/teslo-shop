export const generatePaginationNumbers = (
  ...
  // si el numero total de paginas es 7 o menos avamos a mostrar todas las paginas sin puntos suspensivos
  if (totalPages <= 7) {
    return Array.from({ length: totalPages }, (_, i) => i + 1);
  }

  // si la pagina actual se encuentra entre las primeras 3 paginas
